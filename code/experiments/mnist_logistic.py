...
stdz, power, thresholded, num_frames, seed = list(
    product(stdz_list, power_list, thresholded_list, num_frames_list, list(seed_list))
)[array_task_id]

dataset_dir = MNIST_LENS_DIR[power]
result_dir = RESULT_SUBDIRS["mnist_logistic"]
